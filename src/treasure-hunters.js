...
class TreasureHunters extends React.Component {
	...
	_createPlayers(){
		let playersArray = [];
		playersArray.push({ playerId: 0, playerName: DEAFULT_PLAYER_NAME, row: 0, col: 3, playerClass: "player1", playerType: "human" });
		playersArray.push({ playerId: 1, playerName: "Mike", row: 4, col: 0, playerClass: "player2", playerType: "human" });
		return playersArray;
	}
